...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function restoreSubmitButton() {
        ...
        submitBtn.innerHTML = `<i class="fa-solid fa-circle-check me-2"></i>Submit Application`;
    }
    ...
    function runInference(data) {
        // Preprocessing: 
        // Note: For a single-row DataFrame, quantile calculation for IQR clipping outputs 0 IQR,
        // which leaves values intact. Thus, we directly use input floats (which is what pandas/sklearn does).
